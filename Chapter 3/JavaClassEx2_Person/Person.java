...
public class Person {
    ...
    public void setPerson(String pName, int pAge, double pWeight, double pHeight, Outfit pOutfit) {
        ...
        Outfit cloneOutfit = new Outfit(pOutfit.getType(), pOutfit.getColor(), pOutfit.getSize());
        mOutfit = cloneOutfit; //be careful of shallow copy issue
        //mParents = "xxx";  //uncomment this statement will give error: cannot assign value to a final variable
    }
    ...
    // class method to retrieve the number of objects created
    public static int getCount() {
        return totalCount;
    }

    // class method to access instance variable via an object
    public static void talk(Person p, String msg) {
        System.out.println(p.mName + ">> " + msg);
    }
